...
// ─────────────────────────────────────────────────────────────
// Sidebar + topbar shell for all Patient pages
// ─────────────────────────────────────────────────────────────
...
import {
  ...
  LogOut, Menu, X, Stethoscope, Bell, ChevronRight,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/patient/chatbot",          icon: MessageSquare,   label: "AI Assistant"      },
];
    ...
    >
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-100">
        ...
        <div>
          ...
          <p className="text-xs text-teal-600 font-medium mt-0.5">Patient Portal</p>
        </div>
        {mobile && (
